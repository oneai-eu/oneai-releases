# OneGlue v0.75.0 — Bring your data with you: ITGlue import

**Release Date:** 2026-06-01

Switching documentation tools usually means either a painful manual re-entry or a blank-slate start that loses years of accumulated knowledge. OneGlue's ITGlue import removes that barrier: bring your existing documentation with you — records, files, and all — in a single guided flow.
