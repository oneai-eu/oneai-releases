# OneGlue v0.71.0 — Domaines et DNS, en direct

**Date de publication :** 2026-05-30

Les domaines s'oublient facilement — jusqu'à ce que l'un d'eux expire au pire moment. OneGlue suit désormais vos domaines et leur DNS de la même manière que tout le reste — avec des données en direct tirées directement de la source, de sorte que ce que vous voyez est toujours à jour, et non un instantané saisi par quelqu'un il y a des mois.
