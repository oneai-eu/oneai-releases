# OneGlue v0.98.0 — Notifications, recherche et la connexion à oneAI

**Date de publication :** 2026-06-12

Deux choses rendent un outil de documentation vraiment fluide : pouvoir tout retrouver instantanément, et être averti de ce qui requiert votre attention sans avoir à le chercher. Ce jalon apporte les deux — et ajoute la connexion à oneAI qui donne vie aux capacités d'IA de OneGlue.

## Points forts

- **Une barre de recherche globale unique.** Cherchez dans toutes vos organisations et tous vos actifs depuis le haut de l'application, avec une portée par défaut adaptée au contexte et une correspondance plus intelligente — y compris les recherches multi-mots et partielles — pour retrouver le bon enregistrement même quand vous ne vous souvenez qu'à moitié de son nom.
