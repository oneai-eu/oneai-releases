# OneGlue v0.98.0 — Notifications, search & the oneAI connection

**Release Date:** 2026-06-12

Two things make a documentation tool feel effortless: being able to find anything instantly, and being told what needs your attention without having to go looking. This milestone delivers both — and adds the connection to oneAI that brings OneGlue's AI capabilities to life.

## Highlights

- **A single global search bar.** Search across all your organizations and assets from the top of the app, with a context-aware default scope and smarter matching — including multi-word and partial searches — so you find the right record even when you only half-remember what it's called.
