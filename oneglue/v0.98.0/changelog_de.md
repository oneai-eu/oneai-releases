# OneGlue v0.98.0 — Benachrichtigungen, Suche & die Verbindung zu oneAI

**Veröffentlicht am:** 2026-06-12

Zwei Dinge lassen ein Dokumentationswerkzeug mühelos wirken: alles sofort finden zu können und darüber informiert zu werden, was Ihre Aufmerksamkeit braucht, ohne selbst suchen zu müssen. Dieser Meilenstein liefert beides — und ergänzt die Verbindung zu oneAI, die die KI-Funktionen von OneGlue zum Leben erweckt.

## Highlights

- **Eine einzige globale Suchleiste.** Durchsuchen Sie all Ihre Organisationen und Assets vom oberen Rand der Anwendung aus, mit einem kontextabhängigen Standardbereich und intelligenterer Trefferfindung — einschließlich mehrteiliger und unvollständiger Suchbegriffe — sodass Sie den richtigen Datensatz auch dann finden, wenn Sie sich nur halb an seinen Namen erinnern.
