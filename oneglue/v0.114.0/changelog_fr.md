# OneGlue v0.114.0 — Accès distant et agents pour vos appareils

**Date de publication :** 2026-06-22

La documentation est d'autant plus utile qu'elle est reliée aux appareils réels qui la sous-tendent. Ce jalon comble cet écart : atteignez et gérez vos appareils documentés directement depuis OneGlue, avec un état en direct qui vous indique ce qui est réellement en ligne — et sans outil supplémentaire à jongler pour l'accès au quotidien.

## Points forts

- **Ouvrez un bureau à distance directement dans votre navigateur.** Connectez-vous à un appareil en RDP ou VNC depuis OneGlue lui-même — sans client distinct à installer ou à lancer. Les préréglages de résolution, l'ajustement à la fenêtre et une aide aux raccourcis clavier pour les combinaisons délicates rendent le travail en session distante naturel.
