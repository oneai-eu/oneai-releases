# OneGlue v0.83.0 — Des sauvegardes fiables — et que vous déclenchez vous-même

**Date de publication :** 2026-06-03

Les sauvegardes ne comptent que si vous êtes sûr qu'elles seront là — et qu'elles se restaureront réellement — le jour où vous en avez besoin. OneGlue sauvegarde vos données automatiquement, et ce jalon place ce filet de sécurité entre vos mains, avec de la visibilité et du contrôle plutôt qu'une confiance aveugle dans une tâche planifiée.
